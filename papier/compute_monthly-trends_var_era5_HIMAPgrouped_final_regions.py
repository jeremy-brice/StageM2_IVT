...
month_label = '_'.join([name_months[m-1] for m in months]) # ca donne : [1] -> 'Jan'; ou [1,2,3] -> 'Jan_Feb_Mar'

path = '/bettik/PROJECTS/pr-regional-climate/bricej/paper/'
filename = f"{var}_era5_{month_label}_trends_HIMAPgrouped_regions_{iyear}-{fyear}.csv"
